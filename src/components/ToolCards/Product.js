                ...
                >
                  <div className="toolcard__image">
                    ...
                    <div className="toolcard__preview">
                     <Button className="toolcard__perview-button"  onClick={() => handleToolClick(productData)}> <RemoveRedEyeIcon className="eyes_icon"/> Preview</Button>
                    </div>
                  </div>
                  <div className="toolcard__align toolcard__toolicons">
                    <div className="toolcard__items toolcard__download">
                      {productData.showDownload == false ? (
                    ...
                    <div className="toolcard__items toolcard__shopping">
                      <span className="toolcard__sub-icons">
                        <ShoppingCartIcon  onClick={() => addToCart(productData.id)}/>
                      </span>
                    </div>
                  </div>
                </Paper>
                <div className="toolcard__align toolcard__toolname">
                  <div className="toolcard__aligninr1 toolcard__font-family">{productData.toolname}</div>
                  <div className="toolcard__aligninr toolcard__font-family">${productData.price}</div>
                </div>
